# IAM Project - Copilot Prompts & Instructions

## General Project Context
This is the IAM (Intelligent Analysis of Molecules) project - a comprehensive chemical analysis platform.

## Current Project Structure
- `IAM_GUI/` - Flask web interface with molecular visualization
- `IAM_Knowledge/` - Chemical analysis modules and predictors  
- `IAM_Tools/` - Utility tools and wrappers
...
- Handle missing dependencies gracefully (especially RDKit)

## Common Tasks & Prompts

### Web Interface Prompts
```
# Add new chemical analysis endpoint
# Fix template rendering issues  
# Improve error handling in Flask routes
# Add new visualization features
```

### Chemical Analysis Prompts
```
# Enhance molecular property predictions
# Add new chemical descriptors
# Improve XTB integration
...
- "Create a new analysis module for [chemical property]"
- "Improve the web interface for [specific feature]"
- "Debug import issues in [specific module]"
